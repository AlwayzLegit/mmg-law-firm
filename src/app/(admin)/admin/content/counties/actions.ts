...
export async function updateCounty(formData: FormData): Promise<ActionResult> {
  ...
  revalidatePath(`/admin/content/counties/${parsed.data.id}`);
  revalidatePath("/admin/content/counties");
  revalidatePath("/admin/content/pages");

  return { ok: true };
}

export async function togglePublishCounty(
  formData: FormData,
